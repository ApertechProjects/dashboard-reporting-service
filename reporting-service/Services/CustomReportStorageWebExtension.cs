...
public class CustomReportStorageWebExtension : ReportStorageWebExtension
{
    ...
    public CustomReportStorageWebExtension(IConfiguration configuration)
    {
        _reportDirectory = configuration.GetValue<string>("ReportFilePath");
    ...
    public override byte[] GetData(string url)
    {
        ...
        try
        {
            if (Directory.EnumerateFiles(_reportDirectory).Select(Path.GetFileNameWithoutExtension).Contains(url))
            {
    ...
    public override void SetData(XtraReport report, string url)
    {
        ...
        if (!IsWithinReportsFolder(url, _reportDirectory))
